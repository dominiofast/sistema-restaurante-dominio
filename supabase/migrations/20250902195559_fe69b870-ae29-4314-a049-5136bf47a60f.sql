...
-- Também precisamos configurar regiões de atendimento para essas empresas
...
-- Criar área de entrega circular para Quadrata (raio de 10km)
...
-- Criar área de entrega circular para Domínio (raio de 10km)
INSERT INTO delivery_region_areas (region_id, area_type, area_data)
SELECT 
    dr.id,
    'circle',
...
INSERT INTO public.ai_conversation_logs (
    ...
    'SYSTEM',
    'COORDENADAS_FIX',
    'CORREÇÃO COMPLETA: Coordenadas adicionadas aos endereços e regiões de atendimento criadas para Quadrata e Dominio. Coordenadas: Cacoal/RO (-11.4387, -61.4472) com raio de 10km',
    'system_address_fix',
    now()
);
...
CREATE INDEX IF NOT EXISTS idx_whatsapp_chats_company_id ON public.whatsapp_chats(company_id);
CREATE INDEX IF NOT EXISTS idx_whatsapp_chats_last_message_time ON public.whatsapp_chats(last_message_time DESC);

-- Habilitar RLS
ALTER TABLE public.whatsapp_messages ENABLE ROW LEVEL SECURITY;
ALTER TABLE public.whatsapp_chats ENABLE ROW LEVEL SECURITY;

-- Políticas RLS simplificadas para mensagens (permite acesso a todos por enquanto)
...
-- Políticas RLS simplificadas para chats (permite acesso a todos por enquanto)
CREATE POLICY "Allow all access to whatsapp_chats" 
...
DROP TRIGGER IF EXISTS update_chat_trigger ON public.whatsapp_messages;

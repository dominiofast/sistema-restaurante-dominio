-- ==========================================
-- CORREÇÃO CRÍTICA DE SEGURANÇA RLS - MIGRAÇÃO COMPLETA
-- Correção dos erros identificados pelo linter do Supabase
-- ==========================================
...
-- 4. Recriar função para verificar se usuário pode acessar empresa

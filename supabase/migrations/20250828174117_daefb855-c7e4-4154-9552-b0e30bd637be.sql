...
-- para forçar uso exclusivo do ai-chat-direct
...
INSERT INTO public.app_settings (key, value, description, created_at)
VALUES (
  'emergency_block_legacy_ai', 
  'true', 
  'EMERGÊNCIA: Bloquear todas as funções de IA legadas exceto ai-chat-direct',
  now()
)

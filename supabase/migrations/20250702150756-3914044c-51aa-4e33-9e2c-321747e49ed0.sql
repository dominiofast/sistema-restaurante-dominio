-- Remover criação automática de usuários da função de trigger
-- Manter apenas a criação das configurações padrão
...
BEGIN
    ...
    INSERT INTO public.import_logs (
        ...
        'auto_setup',
        1,
        'Empresa criada com configurações padrão: ' || NEW.name
    );

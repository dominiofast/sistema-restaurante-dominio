-- CORREÇÃO URGENTE DO SISTEMA DE CASHBACK
-- Identificadas falhas críticas que permitem saldo negativo e duplicação
...
-- 4. CRIAR FUNÇÃO PARA CREDITAR CASHBACK COM IDEMPOTÊNCIA

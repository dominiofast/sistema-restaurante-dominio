-- Remover orientação sobre "Fazer Pedido" do prompt genérico
...
Pedidos: você NÃO tira pedidos por mensagem e NÃO pode finalizar pedidos. Sempre direcione o cliente para o cardápio digital {menu_url}.
...
Informe o cardápio: {menu_url} para fazer pedidos.
...
- Para pedidos, sempre direcione para o cardápio digital: {menu_url}

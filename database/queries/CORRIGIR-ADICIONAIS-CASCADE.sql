-- CORRIGIR BUSCA DE ADICIONAIS NA CONFIRMACAO
-- PROBLEMA: Trigger existente impede drop da funcao

-- PRIMEIRO: Dropar TODOS os triggers relacionados
...
-- SEGUNDO: Dropar funcao com CASCADE para garantir
DROP FUNCTION IF EXISTS send_whatsapp_notification_after_items() CASCADE;

-- TERCEIRO: Recriar funcao com busca de adicionais CORRETA
...
BEGIN
    ...
    LOOP
        ...
        -- Buscar adicionais deste item especifico (QUERY SIMPLES E CORRETA)
...
SELECT 'Funcao send_whatsapp_notification_after_items corrigida com CASCADE!' as status;

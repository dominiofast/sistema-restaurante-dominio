-- TESTE MANUAL CORRIGIDO - ID COMO INTEGER
...
-- Criar funcao de teste manual COM INTEGER
DROP FUNCTION IF EXISTS test_whatsapp_manual;

CREATE OR REPLACE FUNCTION test_whatsapp_manual(p_pedido_id INTEGER)
RETURNS TEXT AS $$
DECLARE

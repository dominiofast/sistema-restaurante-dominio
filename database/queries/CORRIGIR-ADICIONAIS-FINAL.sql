...
-- Problema: consulta dos adicionais muito complexa

-- Primeiro, remover funcao atual
DROP FUNCTION IF EXISTS send_whatsapp_notification_after_items();

-- Recriar funcao com busca de adicionais CORRETA
...
SELECT 'Funcao send_whatsapp_notification_after_items corrigida para buscar adicionais!' as status;

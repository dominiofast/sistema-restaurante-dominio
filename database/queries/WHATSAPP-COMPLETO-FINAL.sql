-- =====================================================
-- ATUALIZAÇÃO COMPLETA DA FUNÇÃO WHATSAPP
-- Inclui: Adicionais, Forma de Pagamento, Emojis
-- =====================================================
...
DROP TRIGGER IF EXISTS trigger_debug_simples ON pedido_itens;
DROP FUNCTION IF EXISTS send_whatsapp_notification_after_items() CASCADE;

-- 2. CRIAR FUNÇÃO ATUALIZADA COM ADICIONAIS E PAGAMENTO
...
-- 3. CRIAR TRIGGER
CREATE TRIGGER trigger_whatsapp_completo_final
...
SELECT 
    '✅ Função WhatsApp atualizada com sucesso!' as status,
    'Inclui: Adicionais, Forma de Pagamento, Emojis' as features;
